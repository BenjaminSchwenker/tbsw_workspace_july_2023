...
selected_indices = [744,745,746,747,748,749,750,751,752,753,754,755]
VCLIP = [30,40,50,60,70,80,90,100,110,120,130,140]
...
ax1.errorbar(VCLIP, selected_data['pointing_u'], yerr=selected_data['pointing_error_u'], fmt='o', capsize=5, label='size>0')
...
ax1.errorbar(VCLIP, selected_data['pointing_u'], yerr=selected_data['pointing_error_u'], fmt='o', capsize=5, label='size==1')
...
ax1.errorbar(VCLIP, selected_data['pointing_u'], yerr=selected_data['pointing_error_u'], fmt='o', capsize=5, label='size==2')
...
ax2.errorbar(VCLIP, selected_data['pointing_v'], yerr=selected_data['pointing_error_v'], fmt='o', capsize=5, label='size>0')
...
ax2.errorbar(VCLIP, selected_data['pointing_v'], yerr=selected_data['pointing_error_v'], fmt='o', capsize=5, label='size==1')
...
ax2.errorbar(VCLIP, selected_data['pointing_v'], yerr=selected_data['pointing_error_v'], fmt='o', capsize=5, label='size==2')
...
fig1, ax1 = plt.subplots()
ax1.errorbar(VCLIP, selected_data['cluster_size_u'], yerr=selected_data['cluster_size_u_error'], fmt='o', capsize=5, label='cluster_size_u')
# Extract the data for the specified indices
selected_data = filtered_data.loc[selected_indices]
# Extract the first element from the 'pointing_u' and 'pointing_error_u' columns
...
ax1.errorbar(VCLIP, selected_data['cluster_size_v'], yerr=selected_data['cluster_size_v_error'], fmt='o', capsize=5, label='cluster_size_v')
ax1.set_xlabel('Angle $\\theta$ (degrees)')
...
# name your Pdf file 
filename = "/home/bgnet/tbsw_workspace_july_2023/pointing_clustersize/W02R05_pointing_VCLIP.pdf"  
