...
selected_indices = [685,684,683,682,681,680,679,677]
...
ax1.set_title('W02R05 HV bias scan pointing resolution in u')
ax1.legend()
...
ax2.set_title('W02R05 HV bias scan pointing resolution in v')
ax2.legend()
...
ax1.set_title('W02R05 HV bias scan comparison of cal. and uncal. cluster_size_u')
ax1.legend()
...
# name your Pdf file 
filename = "/home/bgnet/tbsw_workspace_july_2023/pointing_clustersize/W02R05_cal_HVBias.pdf"  
