...
def add_rawinput(path):
  ...
  rawinput.param('SensorNames', "Adenium_0 Adenium_1 Adenium_2 Adenium_3 Adenium_4 Adenium_5 Monopix2_0")
...
def add_hitmakers(path):
  ...
  m26hitmaker.param("SigmaUCorrections", "0.7 0.7 0.7")  
  m26hitmaker.param("SigmaVCorrections", "0.7 0.7 0.7")
  ...
  tj2hitmaker.param("SigmaUCorrections", "0.7 0.7 0.7")  
  tj2hitmaker.param("SigmaVCorrections", "0.7 0.7 0.7")
...
def add_hitmakersDB(path):
  ...
  m26goehitmaker.param("SigmaUCorrections", "1.0 1.0 1.0")  
  m26goehitmaker.param("SigmaVCorrections", "1.0 1.0 1.0")
  ...
  tj2goehitmaker.param("SigmaUCorrections", "1.0 1.0 1.0")  
  tj2goehitmaker.param("SigmaVCorrections", "1.0 1.0 1.0")
...
def create_calibration_path(Env, rawfile, gearfile, energy, useClusterDB):
  ...
  trackfinder_loosecut.param("MaxResidualU","0.9")
  trackfinder_loosecut.param("MaxResidualV","0.9")
...
if __name__ == '__main__':
  ...
  parser.add_argument('--steerfiles', dest='steerfiles', default='steering-files/monopix2-tb/', type=str, help='Path to steerfiles')
  parser.add_argument('--gearfile', dest='gearfile', default='gear_geoid9.xml', type=str, help='Name of gearfile inside steerfiles folder')
  #parser.add_argument('--datapath', dest='datapath', default='/home/benjamin/textdump_tbsw/run000587_textdump.txt', type=str, help='Path to data')
  #parser.add_argument('--datapath', dest='datapath', default='/home/benjamin/textdump_tbsw/run000579_textdump.txt', type=str, help='Path to data')
  #parser.add_argument('--datapath', dest='datapath', default='/home/benjamin/textdump_tbsw/run000597_textdump.txt', type=str, help='Path to data')
  #parser.add_argument('--datapath', dest='datapath', default='/home/benjamin/textdump_tbsw/run000603_textdump.txt', type=str, help='Path to data')
  #parser.add_argument('--datapath', dest='datapath', default='/home/benjamin/textdump_tbsw/run000603_textdump_shift_p1_monopix.txt', type=str, help='Path to data')
  #parser.add_argument('--datapath', dest='datapath', default='/home/benjamin/textdump_tbsw/run000626_textdump.txt', type=str, help='Path to data')
  parser.add_argument('--datapath', dest='datapath', default='/home/benjamin/textdump_tbsw/run000644.txt', type=str, help='Path to data')
